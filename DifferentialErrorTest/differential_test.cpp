...
// 2023/03/19 differential_test
// This program will export txt files into folder "test_double" as it runs.
...
int LIMIT = 200000;
double L = -3.2, R = 3.2; // interval

double x = 0, xf = 0, xb = 0, xff = 0; // variable
double r1[100], r2[100], r3[100], r4[100], r5[100], r6[100], r7[100];
